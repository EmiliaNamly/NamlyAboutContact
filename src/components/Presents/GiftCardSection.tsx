...
export default function GiftCardSection() {
    ...
    return (
        <section className="px-4 md:px-6 py-7 md:py-14 bg-white border-b border-[#1E3A5F]/20">
            <div className="md:max-w-[1240px] bg-[#eef6ff] rounded-2xl md:rounded-3xl shadow-md border border-[#1E3A5F]/20 mx-auto max-w-xl overflow-hidden md:grid md:grid-cols-[0.9fr_1.1fr]">

                <div className="hidden md:block relative min-h-[320px] bg-black">
                    <img
                ...
                <div className="p-8 md:pr-24">
                    <div className="bg-[#eef6ff] flex items-center gap-3.5 mb-4">

                        <div className="md:hidden w-12 h-12 rounded-full overflow-hidden bg-black flex items-center justify-center border border-[#1E3A5F]/20">
                            <img
            ...
            ${useCustom
                    ...
                    <div className="md:flex md:justify-center">
                        <button className="w-full md:w-auto md:px-20 bg-black hover:bg-[#1E3A5F] text-white py-3.5 rounded-2xl font-bold uppercase text-[13px]">
